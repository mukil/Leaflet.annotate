...
| `domId` (Optional) | Text | Allows you to set the DOM ID for the HTML element (either *article*, or *metadata*) which wraps all metadata statements for one specific map element. |
